...
class TestGetUser(unittest.TestCase):
    ...
    def test_admin_update_user_role_success(self):
        ...
        res = app.test_client().put('/admin/user/name/update/' + tmp_oid, headers=self.headers_sent, data=json.dumps(body_to_send))
...
"""
    def test_admin_update_user_name_missing_data(self):
        body_to_send = {'A': 'B'}
        res = app.test_client().put('/admin/user/name/update/<user_id>', headers=self.headers_sent, data=json.dumps(body_to_send))
