...
class TestGetAllNoneClients(unittest.TestCase):
    def setUp(self):
    ...
    def test_get_all_non_clients_as_admin_successfully(self):
        self.maxDiff = None
        res = app.test_client().get('/user/coaches', headers=self.headers_sent)
